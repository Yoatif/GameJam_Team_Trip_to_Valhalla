class scene3 extends Phaser.Scene {
                    ...
                    preload() {
                        ...
                        this.load.tilemapTiledJSON('scene3', '../LD/scene3.json');
                    ...
                    create(){
                        const levelmap = this.add.tilemap("scene3");
                ...
                tirer() {
                    ...
                    if (this.player.direction == "left") { 
                        console.log("bygzu")
                        this.root = this.groupeBoule.create(this.player.x - 25, this.player.y - 4, "attack_left");
                        this.root.setVelocity(-400,0);
                    }
                    if (this.player.direction == "right") {
                        console.log("bygzu")
                        this.root = this.groupeBoule.create(this.player.x + 25, this.player.y - 4, "attack_right"); 
                        this.root.setVelocity(400,0);
                    }
                    if (this.player.direction == "up") {
                        console.log("bygzu")
                        this.root = this.groupeBoule.create(this.player.x, this.player.y - 4, "attack_up");
                        this.root.setVelocity(0,-400);
                    }
                    if (this.player.direction == "down") { 

                        this.root = this.groupeBoule.create(this.player.x, this.player.y - 4, "attack_down");
                        this.root.setVelocity(0,400);
                    }
