class scene2 extends Phaser.Scene {
                    ...
                    preload() {
                        ...
                        this.load.tilemapTiledJSON("scene2", "../LD/Proto_scene_2-resize.json");
                        this.load.image("jeudetuile","../assets/Tiles.png"); 
                        this.load.image("attack","../assets/attack.png");
                        this.load.image("mines","../assets/mine.png");
                ...
                // permet de créer la map, les collisions, et les déplacements
                        ...
                        const carteDuNiveau = this.add.tilemap("scene2");
                         ...
                         const mines = carteDuNiveau.addTilesetImage(
                             "mine",
                             "mines",
                         )
